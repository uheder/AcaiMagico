...
<template>
  ...
  <div class="items-center justify-center  bg-white shadow-md">
    <div class="border-b border-gray-900/10 pb-4 bg-[url('@/assets/background.png')] bg-cover bg-no-repeat flex items-end h-50 justify-center w-full">
      <a href="https://api.whatsapp.com/send?phone=558481932744" target="_blank">
      ...
      <a href="https://www.instagram.com/acai_magico4/" target="_blank">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-7 lg:w-10 h-7 lg:h-10" viewBox="0 0 48 48">
