  ...
  <div
    ...
    <table class="w-full text-left table-auto min-w-max">
      ...
      <tr class="hover:bg-slate-50">
        ...
        <td class="p-4 border-b border-slate-200 py-5">
          <p class="text-sm text-slate-500 flex-auto max-w-[118px] min-w-[80px]"><input type="number" value="1"
                                                                                        v-model="quantidade"></p>
        </td>
        <td class="p-4 border-b border-slate-200 py-5">
        ...
        <div class="mt-4">
          ...
          <div v-if="data.tipo_entrega === 'entrega'">
              ...
              <label for="telefone_cliente" class="block text-sm/6 font-medium text-gray-900">Telefone</label>
                <input v-model="data.telefone_cliente" minlength="9" maxlength="12" name="telefone_cliente"
            ...
            <div>
              ...
              <label for="rua" class="block text-sm/6 font-medium text-gray-900">Rua</label>
                <input v-model="data.rua" name="rua" id="rua" placeholder="Nome da Rua"
              ...
              <label for="numero" class="block text-sm/6 font-medium text-gray-900">Numero</label>
                <input v-model="data.numero" name="numero" id="numero" placeholder="Número"
            ...
            <div class="mt-2">
              ...
              <select v-model="data.bairro" class="rounded-md bg-white text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
            ...
            <fieldset v-if="data.forma_pagamento === 'dinheiro'">
              ...
              <div class="inline-flex gap-x-5">
                <div class="flex items-center gap-x-2">
                  <input type="radio" v-model="data.troco" name="troco" value="nao" id="troco" checked class="relative size-4 appearance-none rounded-full border border-gray-300 bg-white before:absolute before:inset-1 before:rounded-full before:bg-white not-checked:before:hidden checked:border-indigo-600 checked:bg-indigo-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 disabled:border-gray-300 disabled:bg-gray-100 disabled:before:bg-gray-400 forced-colors:appearance-auto forced-colors:before:hidden">
                  <label for="nao" class="block text-sm/6 font-medium text-gray-900">Não</label>

                  <input type="radio" v-model="data.troco" name="troco" value="sim" id="troco" class="relative size-4 appearance-none rounded-full border border-gray-300 bg-white before:absolute before:inset-1 before:rounded-full before:bg-white not-checked:before:hidden checked:border-indigo-600 checked:bg-indigo-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 disabled:border-gray-300 disabled:bg-gray-100 disabled:before:bg-gray-400 forced-colors:appearance-auto forced-colors:before:hidden">
                  <label for="sim" class="block text-sm/6 font-medium text-gray-900">Sim</label>
                </div>
              </div>
            </fieldset>
            <fieldset v-if="data.troco === 'sim'">
              <legend class="text-sm/6 font-semibold text-gray-900">Para quanto?</legend>
              <input v-model="data.troco_para" name="troco_para" id="troco_para" placeholder="Troco para quanto?" class="block w-[50%] rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
            </fieldset>
