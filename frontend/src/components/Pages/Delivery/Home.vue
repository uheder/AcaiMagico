...
<template>
  ...
  <div class="sm:max-w-full md:max-w-[90%]  lg:w-[75%] xl:max-w-[60%] mx-auto items-center justify-center  bg-white shadow-md">
    <div class="border-b border-gray-900/10 pb-4 bg-[url('/background.png')] bg-cover bg-center bg-no-repeat')] h-50 flex items-end justify-center lg:h-110">
      <a href=""></a>
        <svg xmlns="http://www.w3.org/2000/svg" class="w-7 lg:w-10 h-7 lg:h-10" viewBox="0 0 48 48">
    ...
    <form @submit.prevent="submit()">
      ...
      <div class="mt-4 flex justify-center gap-x-6 pb-2">
        <button class="text-center rounded-md w-[60%] md:w-[40%] lg:w-[30%] mt-6 bg-purple-900 py-2 px-4 border border-transparent text-sm text-white transition-all shadow-md hover:shadow-lg focus:bg-cyan-700 focus:shadow-none active:bg-cyan-700 hover:bg-purple-950 active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
          ...
          <img src="/svgCart.svg" class="w-6 h-6 inline-flex" alt="Adicionar ao carrinho">
        </button>
      </div>
    </form>
  </div>
